...
export function ChangeTextArray() {
    return(
        //PRC
        subVariable === "pcrLac" ? contentArray = contentArrayPrcLac
        : subVariable === "pcrCrianca" ? contentArray = contentArrayPrcCrianca 
        : subVariable === "pcrAdulto" ? contentArray = contentArrayAdulto
        //Queda
        : subVariable === "fratura" ? contentArray = contentArrayFratura
        : subVariable === "luxCotovelo" ? contentArray = contentArrayLuxCotovelo
        : subVariable === "luxClavicula" ? contentArray = contentArrayLuxClavicula
        : subVariable === "traumaQuadril" ? contentArray =  contentArrayTraumaQuadril
        : subVariable === "traumaCranio" ? contentArray = contentArrayTraumaCranio
        //Queimadura
        : subVariable === "primeiroGrau" ? contentArray = contentArrayPrimeiroGrau
        : subVariable === "segundoGrau" ? contentArray = contentArraySegundoGrau
        : subVariable === "terceiroGrau" ? contentArray = contentArrayTerceiroGrau 
        //Engasgo
        :subVariable === "engasLac" ? contentArray = contentArrayEngasLac 
        :subVariable === "engasInconsistente" ? contentArray = contentArrayEngasInconsistente 
        :subVariable === "engasCrianca" ? contentArray = contentArrayEngasCrianca 
        :subVariable === "engasInconsistenciaCrianca" ? contentArray = contentArrayEngasInconsistenciaCrianca
        :subVariable === "choques" ? contentArray = contentArrayChoque
        : contentArray = contentArrayAfogamento
    );
}
